  ...
  return (
    <>
      <Tabs defaultValue="all-restaurants" className="w-full">
        <TabsList className="flex text-[14px] pt-8 pb-7 px-3 border-b border-r border-l mt-[-17px] rounded-b-lg transition-all ease-in-out duration-1000">
        ...
        <TabsContent value="pending">
          <PendingRestaurantTable header={headerPend} />
        </TabsContent>
      </Tabs>
    </>
  );
